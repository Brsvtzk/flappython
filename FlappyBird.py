...
IMAGEM_BASE = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'base.png')))
IMAGEM_BG = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'bg.png')))
IMAGENS_BIRD = [pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'bird1.png'))),
